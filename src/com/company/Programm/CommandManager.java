...
import com.company.Parser.TokenType;
...
public class CommandManager {
     ...
     */
    protected LinkedHashMap<String,Command> commands = new LinkedHashMap<String, Command>();

    public CommandManager(CollectionController controller, Scanner scanner){
        registerCommand(new HelpCommand(this));
        registerCommand(new InfoCommand(controller));
        registerCommand(new ShowCommand(controller));
        registerCommand(new InsertCommand(controller, scanner));
        registerCommand(new UpdateCommand(controller, scanner));
        ...
        registerCommand(new ReplaceIfGreaterCommand(controller, scanner));
        registerCommand(new RemoveAllByDistance(controller));
        registerCommand(new RemoveLowerKeyCommand(controller));
        registerCommand(new CountGreaterThanDistance(controller));
        registerCommand(new CountLessThanDistance(controller));
        registerCommand(new RemoveGreater(controller));
    }
