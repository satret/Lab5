...
public class Route implements Comparable<Route> {
     ...
     * Пункт прибытия
     */
    private Location2 to; //Поле может быть null
    /**
     * Дистанция
     */
    ...
    public Route(long id, String name, Coordinates coordinates, Location from, Location2 to, Long distance) {
        setId(id);
        setName(name);
    ...
    public void setTo(Location2 to) {
        this.to = to;
    }
    ...
    public void setDistance(Long distance) {
        ...
        this.distance = Math.toIntExact(distance);
    }
