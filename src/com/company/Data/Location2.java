 ...
 */
public class Location2 implements Comparable<com.company.Data.Location2> { // Тут вышла ошибка генератора, сгенерированы два разных класса Location
    /**
     * Координата x
     */
    private int x;
    ...
    public Location2(int x, Integer y, String name){
        setX(x);
        setY(y);
        setName(name);
    }
    ...
    public boolean equals(Object other){
        ...
        com.company.Data.Location2 o = (com.company.Data.Location2) other;
    ...
    @Override
    public int compareTo(com.company.Data.Location2 other) {
